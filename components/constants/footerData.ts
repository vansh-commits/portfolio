import { Github, Linkedin, Mail, Twitter, Coffee, Code, Zap } from "lucide-react"
...
export const funFacts = [
  { icon: Coffee, text: "Fueled by coffee and clean commits", color: "text-amber-400" },
  { icon: Code, text: "Tabs over spaces (don’t @ me)", color: "text-cyan-400" },
  { icon: Zap, text: "Ship fast, iterate faster", color: "text-lime-400" },
]
